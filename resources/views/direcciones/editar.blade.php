...
@section('content')
<head>
<!--Script para cargar el municipio y colonia al cargar la pagina en base al cp -->
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var cpElement = document.getElementById('cp');
        if (cpElement.value.length === cpElement.maxLength) {
            limitInputLength(cpElement, cpElement.maxLength);
        }
    });
</script>
...
<section class="section">
        ...
        <a href="">
        <h3 style="color: black;" class="page__heading">Editar Direccion</h3>
        </a>
        </div>
        <div class="section-body">
        <div class="card">
            <div class="card-header" style="background-color: black; margin-bottom: -20px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);">
                <strong><p style="font-size: 16px; font-family: nunito; color: White; margin-top: -10px;" class="card-title">Edicion Direccion</p></strong>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            {!! Form::open(['route' => ['direcciones.update', $direccion->id], 'method' => 'PUT', 'onsubmit' => 'return validarSeleccionColonia()']) !!}
                            ...
                            <!-- Otros campos del formulario -->
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('nombre', $direccion->name, array('class' => 'form-control uppercase-input', 'readonly')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="a_p_lbl">Apellido Paterno</label><span class="required text-danger">*</span>
                                        {!! Form::text('apellido_p', $direccion->a_p, array('class' => 'form-control uppercase-input', 'readonly')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="a_m_lbl">Apellido Materno</label><span class="required text-danger"></span>
                                        {!! Form::text('apellido_m', $direccion->a_m, array('class' => 'form-control uppercase-input','readonly')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="cp_lbl">Código Postal</label><span class="required text-danger">*</span>
                                        {!! Form::text('codigo_postal', $direccion->c, ['class' => 'form-control', 'id' => 'cp', 'maxlength' => 5, 'oninput' => 'limitInputLength(this, 5)']) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('calle', $direccion->ca, array('class' => 'form-control uppercase-input')) !!}
                                    </div>
                                </div>                            
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="n_e_lbl">No. Exterior</label><span class="required text-danger">*</span>
                                        {!! Form::number('numero_ex', $direccion->no_e, array('class' => 'form-control uppercase-input')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="n_i_lbl">No. Interior</label>
                                        {!! Form::number('numero_int', $direccion->no_i, array('class' => 'form-control uppercase-input')) !!}
                                    </div>
                                </div>
                            </div>
