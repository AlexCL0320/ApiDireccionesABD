                                    ...
                                    {!! Form::model($colonia, ['route' => ['colonias.update', $colonia->id], 'method' => 'PUT']) !!}
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('nombre', $colonia->n, array('class' => 'form-control', 'id' => 'nombre')) !!}
                                            </div>
                                            <div class="form-group">
                                                    <label for="cp_lbl">Código Postal</label><span class="required text-danger">*</span>
                                                    {!! Form::text('codigo_postal_col', $colonia->c, ['class' => 'form-control', 'readonly', 'id' => 'cp2', 'style' => 'width: 20%;']) !!}
                                                </div>
                                                <div class="d-flex align-items-center" style="margin-top: -1%">
                                                    ...
                                                    <label style="color:black; font-family: nunito; font-size: 13.5px" for="cp_lbl">Estado</label><span class="required text-danger">*</span>
                                                        {!! Form::text('estado_col', $colonia->n_e, ['class' => 'form-control', 'readonly', 'id' => 'estado2', 'style' => 'width: 120%;']) !!}
                                                    </div>
                                                    <div style="margin-left: 5%;">
                                                        <label style="color:black; font-family: nunito; font-size: 13.5px">Municipio</label><span class="required text-danger">*</span>
                                                        {!! Form::text('municipio_col', $colonia->n_m, ['class' => 'form-control', 'readonly', 'id' => 'municipio2', 'style' => 'width: 220%;']) !!}
                                                    </div>
                                                </div>
                                                <br>
                                            </div>
                                            <div style="margin-left: 1.5%;">
                                                ...
                                                <select style="width: 100%; margin-right: 5%; margin-top:0%" id="colonia2" class="form-control" disabled>   
                                                      <option value= "1">{{ $colonia->n }}</option>        
                                                </select>
                                            </div>
                                            <br>
