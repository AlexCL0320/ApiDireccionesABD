                    ...
                    <div class="card">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('nombre', $colonia->nombre, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('municipio', $municipios, $colonia->municipio->nombre, ['class' => 'form-control', 'placeholder' => 'Seleccionar el municipio', 'id' => 'paraje']) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
